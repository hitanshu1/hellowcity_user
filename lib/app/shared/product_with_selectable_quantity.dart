...
class ProductWithSelectableQuantity extends StatelessWidget {
  final ProductItemModel item;
  final Function? onIncreaseQuantity,onDecreaseQuantity;
  final bool available,showQuantity;
  ProductWithSelectableQuantity({Key? key,required this.item,this.onDecreaseQuantity,
    this.onIncreaseQuantity,required this.available,this.showQuantity:true}) : super(key: key);
