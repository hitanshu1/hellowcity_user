...
class CustomDraggableFloatingActionButton extends StatefulWidget {
  ...
  CustomDraggableFloatingActionButton(
      {this.buttons,
        this.positionTop,
        this.positionLeft,
        this.borderColor,
...
class _FloatBoxState extends State<CustomDraggableFloatingActionButton> {
  ...
  Widget build(BuildContext context) {
    ...
    double _totalButtons() {
      if (widget.buttons == null) {
        ...
        return widget.buttons?.length.toDouble()??0;
      }
    }
    ...
    Border? _panelBorder() {
      if (widget.borderWidth != null &&( widget.borderWidth??0) > 0) {
        return Border.all(
      ...
      child: AnimatedContainer(
        ...
        child: Wrap(
          ...
          children: [
            ...
            if( _panelState==PanelState.open)Visibility(
